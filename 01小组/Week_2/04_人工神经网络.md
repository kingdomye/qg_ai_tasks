...
class Layer:
    def __init__(self, num_inputs, num_neurons):
        self.neurons = [Neuron(np.random.uniform(-1, 1, num_inputs)) for _ in range(num_neurons)]
        self.output = []
...
class ANN:
    def __init__(self, num_inputs, num_hidden_layers, num_neurons_per_hidden_layer, num_outputs):
        self.layers = [Layer(num_inputs, num_neurons_per_hidden_layer)]
        for _ in range(num_hidden_layers - 1):
            self.layers.append(Layer(num_neurons_per_hidden_layer, num_neurons_per_hidden_layer))
        self.layers.append(Layer(num_neurons_per_hidden_layer, num_outputs))
```
